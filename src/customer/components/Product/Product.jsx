              ...
              <div>
                ...
                <form className="hidden lg:block">
                        ...
                        <>
                            ...
                            <div className="space-y-4">
                                ...
                                <div key={option.value} className="flex items-center">
                                    ...
                                    defaultValue={option.value}
                                    type="checkbox"
                                    defaultChecked={option.unChecked}
                                    className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                    />
                                    <label
                    ...
                    <Disclosure as="div" key={section.id} className="border-b border-gray-200 py-6">
                        ...
                        <>
                            <h3 className="-my-3 flow-root ">
                            <Disclosure.Button className="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-500 hover:text-gray-700">
                                <span className="font-medium text-gray-900">{section.name}</span>
                                {/* <FormLabel sx={{color: "grey", fontWeight:"bold", opacity:"50"}} className="text-black" id="demo-radio-buttons-group-label">{section.name}</FormLabel> */}
                                <span className="ml-6 flex items-center">
                                {open ? (
                                    <MinusIcon className="h-5 w-5" aria-hidden="true" />
                                ) : (
                            ...
                            <RadioGroup
                                ...
                                //   </div>
                                    ...
                                    <>
                                    <FormControlLabel onChange={(e,sectionId)=>handleRadioFilterChange(e, sectionId)} value={option.value} control={<Radio />} label={option.value} />
                                    </>
